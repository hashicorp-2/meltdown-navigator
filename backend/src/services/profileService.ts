...
import { AiProfileModel, type AiProfile } from '../models/AiProfile.js';
import {
 ...
 */
function profileToDTO(profile: AiProfile): ProfileResponseDTO {
...
export class ProfileService {
   ...
   */
  async createProfile(payload: CreateProfileRequestDTO): Promise<ProfileResponseDTO> {
   ...
   */
  async updateProfile(userId: string, payload: UpdateProfileRequestDTO): Promise<ProfileResponseDTO> {
